...
export async function POST(_request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  return Response.json({ portfolioId: id, mode: "illustrative-demo", startingValue: 10000, endingValue: periods.at(-1)?.value ?? 10000, maximumDrawdown: 0, periods, allocations, disclaimer: "Illustrative demo data; not historical performance or a prediction." });
}
